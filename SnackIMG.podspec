...
Pod::Spec.new do |spec|
  ...
  spec.description  = "SnackIMG.SnackIMG.SnackIMG.SnackIMG.SnackIMG.SnackIMG.SnackIMG."

  spec.homepage     = "https://github.com/Snackstops/SnackIMG"
  ...
  spec.source       = { :git => "https://github.com/Snackstops/SnackIMG.git", :tag => "#{spec.version}" }
